      ...
      <div className="transition-all duration-500 flip-card border-0 w-full">
        <div className="flip-card-inner">
          <div className="flip-card-front bg-sky-200 w-full h-full rounded-lg shadow-lg">
            <h1 className="text-2xl text-sky-900 font-bold">{title}</h1>
            <h2 className="text-xl text-sky-800">{date}</h2>
          </div>
          <div className="transition-all duration-500 flip-card-back rounded-lg bg-red-200 w-full shadow-lg">
            <h1 className="text-2xl text-red-900 font-bold">{title}</h1>
            <h2 className="text-xl text-red-800">{date}</h2>
          </div>
        </div>
      </div>
    </DarkDiv>
